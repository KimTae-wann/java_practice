...
public class ContactManager {
	...
	// ex> "김"을 파라미터로 전달하면 name, firstName, lastName에
	//     "김"이 포함된 연락처의 모든 정보를 출력.
	//
	// contactList에서 이메일 검색 결과 출력하는 기능.
	// ex> "@abc.com"을 파라미터로 전달하면 이메일에 "@abc.com"이 포함된
	//      연락처의 모든 정보를 출력.
	...
	// 4. 삭제하려는 연락처의 정보를 이용한 연락처 삭제 기능
	// ex> 이름이 "김"인 연락처는 삭제한다. 전화번호 마지막 자리가 7777인 연락처는 삭제한다.
