...
import exceptions.custom.DivideByZeroException;
import exceptions.custom.NullOperatorException;
import exceptions.custom.WrongOperatorException;
...
//			return 0;
		...
		if (operator.equals("+")) {
			...
			if (a == 0 || b == 0) {
				throw new DivideByZeroException("잘못된 숫자 입니다.");
...
//			System.out.println("잘못된 연산자 입니다.");
	...
	public static void main(String[] args) {
		...
		catch(NullOperatorException noe) { //연산자가 null 일 때의 처리
			System.out.println("연산자가 비어있습니다. 연산자를 채워서 다시 실행하세요.");
		}
		catch(DivideByZeroException dze) {
			System.out.println("0으로 나누려 했습니다. 숫자를 제대로 작성해서 다시 실행하세요.");
